...
TX_EVENT_HANDLERS.requestPlayerMugshot = function(eventData)
    local playerId = tonumber(eventData.id)
    if not playerId then return end
    TriggerClientEvent('txcl:plist:reqMugshot', playerId, playerId)
end
