...
export type PlayerUpdatedEventType = {
    mutex: string,
    type: 'playerUpdated',
    netid: number,
    mugshot?: string,
...
export type PlayerlistEventType = FullPlayerlistEventType | PlayerDroppedEventType | PlayerJoiningEventType | PlayerUpdatedEventType;
